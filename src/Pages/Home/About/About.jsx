              ...
              <CardBody>
                <Stack mt="6" spacing="3">
                  ...
                  <Text className="text-white text-center mt-4 italic md:text-lg">
                    ...
                    camaraderie. From beginners to advanced practitioners, join
                    us for an unforgettable summer of skill development,
                    cultural exploration, and personal growth. Engage in daily
                    training led by seasoned martial arts masters, explore
                    traditional techniques, and enjoy team-building activities.
                    Our summer camp blends physical prowess with mental focus,
                    creating an enriching environment for students of all
                    levels.
                  </Text>
